...
export default function Product() {
  return (
    ...
    &nbsp; &nbsp; &nbsp; &nbsp; 
    <div className="div">
      <label className="label">Year* &nbsp;</label><br/>
    ...
    &nbsp; &nbsp; &nbsp; &nbsp;
    <div className="div">
      <label className="label">Period* &nbsp;</label><br/>
  ...
  <div className="content_1">
    ...
    &nbsp; &nbsp; &nbsp; &nbsp;
    <div className="div">
      <label className="ab-c">Auditor Name&nbsp;</label><br/>
      ...
      &nbsp; &nbsp; &nbsp; &nbsp;
        ...
        <div  className='container-fluid containerfluidnew'>
                ...
                <div style={{paddingTop: "11px"}}>
                    ...
                    <span style={{marginRight: "0.7rem", color: "#86898b"}}><i class="fa fa-undo" aria-hidden="true"></i> Reset Device</span>
<span style={{marginLeft: "0.7rem",color: "#86898b"}}><span>**</span>| Get Activation Code</span>
